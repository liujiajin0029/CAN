...
{
    {NODE_NUMBER3, Pre_IsFinish, PRECHARGEM_STATENOTOK, Pre_NoAct, NODE_NUMBER1},
};
...
/*Node2 放电故障判断*/
    /*故障 断开总正 进入Node0*/
    {NODE_NUMBER2, Pre_Diagnosis, PRECHARGEM_STATEOK, Pre_StopMaster, NODE_NUMBER0},
    /*充电中 继续充电*/
    {NODE_NUMBER2, Pre_Diagnosis, PRECHARGEM_STATENOTOK, Pre_NoAct, NODE_NUMBER2},
};
