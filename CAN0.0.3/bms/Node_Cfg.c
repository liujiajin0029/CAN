...
Node_MsgType  Node_MsgData[3][4] =
{
	/*Node0 判断故障*/
	{
		/*故障 继续判断故障*/
		{ NODE_NUMBER0, PrechargeM_Diagnosis,  PRECHARGEM_OK, PrechargeM_NoAct, NODE_NUMBER0 },
		/*无故障 开始预充 进入预充完成判断Node1*/
		{ NODE_NUMBER0, PrechargeM_Diagnosis,  PRECHARGEM_NOTOK, PrechargeM_StartPre,NODE_NUMBER1},
	},
	/*Node1 预充完成判断*/
	{
		/*故障 断开预充 进入Node0*/
